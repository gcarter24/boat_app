...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { age: @passenger.age, boat_id: @passenger.boat_id, name: @passenger.name, status: @passenger.status } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { age: @passenger.age, boat_id: @passenger.boat_id, name: @passenger.name, status: @passenger.status } }
